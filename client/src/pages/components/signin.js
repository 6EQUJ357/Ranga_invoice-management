                               ...
                               {/* end card */}
                                ...
                                <div className="mt-5 text-center">
                                    <p className="mb-0 text-muted">©
                                        <script>document.write(new Date().getFullYear())</script>Design & Developed By <i className="mdi mdi-heart text-danger"></i><a href='#' style={{color:"red", fontWeight:"bold"}} target='_blank'>Ranga</a>.  
                                    </p>
                                </div>
                            </div>
                        </div>
