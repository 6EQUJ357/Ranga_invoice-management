                                            ...
                                            <div className="col-lg-6">
                                                <div className="p-lg-5 p-4">
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-muted mt-2">Get your free account now</p>
                                                    </div>
...
{/*                 
                                            ...
                                            <div className="col-lg-6">
                                                <div className="d-flex h-100 bg-auth align-items-end" style={{backgroundImage :(imageURL && !formik.errors.userimg) ? `url(${imageURL})`:`url('assets/images/favicon_io/android-chrome-512x512.png')`}}>
                                                    <div className="p-lg-5 p-4">
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <script>document.write(new Date().getFullYear())</script>Design & Developed By <i className="mdi mdi-heart text-danger"></i><a href='#' style={{color:"red", fontWeight:"bold"}} target='_blank'>Ranga</a>.                                      </p>
                                </div>
                            </div>
                        </div>
                    </div>
